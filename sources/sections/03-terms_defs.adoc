...
// ==== Email
//
// EDITOR: find a normative reference for an IETF RFC822 email, might be a higher number now
//
// ==== Epoch
//
...
An initiative for interoperability of security capabilities (products, technologies, organizations, services, etc.).
