...
GENERAL ATTEMPT (DOESN'T WORK):

[yaml2text,sections/10-events.yaml,paths]
----
{% for path in paths %}
...
ENUMERATED ATTEMPT (WORKS):

[json2text,ocsf-schema/events/application/api.json,event]
--
include::../event.liquid[]
--

[json2text,ocsf-schema/events/application/application.json,event]
--
include::../event.liquid[]
--
